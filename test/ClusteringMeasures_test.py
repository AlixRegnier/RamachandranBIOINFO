...
try :
    a = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(1,1,1,1)
    b = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(1,2,3,1)
    assert(a == 0)
...
try :
    ...
    C = ClusteringMeasures("angles_1TEY_small_clust1.txt").a(cp)
    d1 = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(2,5,-1.296614,2.370531)
    d2 = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(2,5,-1.511338,-0.570213)
    m = (d1 + d2 )/ 2
    assert(C == m)
...
try : 
    Cp = ClusterPoint(2,5,"1")
    Cm = ClusteringMeasures("angles_1TEY_small_clust1.txt").b(cp)
    d1 = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(2,5,-0.841249,2.507612)
    d2 = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(2,5,-0.842724,-0.446035)
    m_c2 = (d1 + d2 )/ 2
    d1 = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(2,5,-1.535437,2.406232)
    d2 = ClusteringMeasures("angles_1TEY_small_clust1.txt").distance(2,5,-1.530744,2.089859)
    m_c3 = (d1 + d2)/ 2
    assert(Cm==m_c3)
...
try :
    ...
    Clust=ClusteringMeasures("angles_1TEY_small_clust1.txt").coefficient_silhouette_i(cp)
